...
class ReporteTotalFarmacia(View): 
    ...
    def cabecera(self,pdf ):
        ...
        pdf.setFont("Helvetica", 24)
        #Dibujamos una cadena en la ubicación X,Y especificada
        pdf.drawString(500, 2500, u"REPORTE ARTICULOS CAE")
        pdf.setFont("Helvetica", 22)
        pdf.drawString(400, 2450, u"TOTAL DE CANTIDADES SOLICITADAS")
        pdf.setFont("Helvetica", 20)
        pdf.drawString(200, 2300, u"FECHA: " + str(datetime.date.today()))
        pdf.setFont("Helvetica", 20)
        pdf.drawString(800, 2300, u"DE BODEGA: FARMACIA")
