...
class ReportePedidosPDF(View): 
    ...
    def tabla(self,pdf,y, id_especialidad):
        ...
        if count <=30:
              ...
              detalle_orden.drawOn(pdf, 800, 2640)
              ...
              #Definimos la coordenada donde se dibujará la tabla
              detalle_orden.drawOn(pdf, 800, 1200)
        elif count >110 and count <=130:
              #Definimos la coordenada donde se dibujará la tabla
              detalle_orden.drawOn(pdf, 800, 800)
        elif count >130 and count <=150:
              #Definimos la coordenada donde se dibujará la tabla
              detalle_orden.drawOn(pdf, 800, 600)
...
class ReporteTotalFarmacia(View): 
    ...
    def cabecera(self,pdf ):
        ...
        pdf.setFont("Helvetica", 24)
        #Dibujamos una cadena en la ubicación X,Y especificada
        pdf.drawString(500, 2000, u"REPORTE ARTICULOS CAE")
        pdf.setFont("Helvetica", 22)
        pdf.drawString(1000, 2250, u"TOTAL DE CANTIDADES SOLICITADAS")
        pdf.setFont("Helvetica", 20)
        pdf.drawString(1500, 2200, u"FECHA: " + str(datetime.date.today()))
        pdf.setFont("Helvetica", 20)
        pdf.drawString(800, 2200, u"DE BODEGA: FARMACIA")
...
class ReporteTotalEcono(View): 
    ...
    def tabla1(self,pdf,y):
        ...
        detalle_orden.wrapOn(pdf, 1000, 1000)
        #Definimos la coordenada donde se dibujará la tabla
        detalle_orden.drawOn(pdf, 400, 750)
    ...
    def tabla2(self,pdf,y):
        ...
        detalle_orden.wrapOn(pdf, 1000, 1000)
        #Definimos la coordenada donde se dibujará la tabla
        detalle_orden.drawOn(pdf, 900, 700)
