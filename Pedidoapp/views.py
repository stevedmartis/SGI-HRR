...
class ReporteTotalPDF(View): 
    ...
    def tabla(self,pdf,y):
        ...
        #Creamos una lista de tuplas que van a contener a las personas
        detalles = [(art.cod_experto, art.nombre, art.stock, art.info_bodega, art.total_pedido) for art in Articulo.objects.filter(info_bodega=1).filter([cod_experto=211-0002, cod_experto=218-0103]).order_by('cod_experto')]
        #Establecemos el tamaño de cada una de las columnas de la tabla
