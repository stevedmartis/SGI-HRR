...
class ReportePedidosPDF(View): 
    ...
    def tabla(self,pdf,y, id_especialidad):
        ...
        encabezados = ('Especialidad', 'Codigo Experto', 'Nombre Articulo', 'Cantidad', 'Estado', 'Estado')
        #Creamos una lista de tuplas que van a contener a las personas
        detalles = [(pedido.especialidad.nombre, pedido.articulo.cod_experto, pedido.articulo.nombre, pedido.cantidad, pedido.estado, pedido.estado_update) for pedido in Pedido.objects.filter(especialidad=especialidad)]
        ...
        if count <=30:
              ...
              #Definimos la coordenada donde se dibujará la tabla
              detalle_orden.drawOn(pdf, 1000, 900)
              ...
              #Definimos la coordenada donde se dibujará la tabla
              detalle_orden.drawOn(pdf, 1000, 1200)
        elif count >110 and count <=130:
              #Definimos la coordenada donde se dibujará la tabla
              detalle_orden.drawOn(pdf, 1000, 800)
        elif count >130 and count <=150:
              #Definimos la coordenada donde se dibujará la tabla
              detalle_orden.drawOn(pdf, 1000, 600)
        elif count >150 and count <=170:
              #Definimos la coordenada donde se dibujará la tabla
              detalle_orden.drawOn(pdf, 1000, 200)
...
class ReporteTotalPDF(View): 
    ...
    def tabla1(self,pdf,y):
        ...
        #Creamos una lista de tuplas que van a contener a las personas
        detalles = [(art.cod_experto, art.nombre, art.stock, art.info_bodega, art.total_pedido) for art in Articulo.objects.filter(cod_experto__range=["AA-0001", "BP-0007"]).filter(info_bodega=1).order_by('cod_experto')]
        #Establecemos el tamaño de cada una de las columnas de la tabla
    ...
    def tabla2(self,pdf,y):
        ...
        encabezados = ('Codigo Experto', 'Nombre Articulo', 'Stock', 'Bodega', 'Total Pedido')
        #Creamos una lista de tuplas que van a contener a las personas
        detalles = [(art.cod_experto, art.nombre, art.stock, art.info_bodega, art.total_pedido) for art in Articulo.objects.filter(cod_experto__range=["BP-0008", "DRE-0160"]).filter(info_bodega=1).order_by('cod_experto')]
        #Establecemos el tamaño de cada una de las columnas de la tabla
        detalle_orden = Table([encabezados] + detalles, colWidths=[3 * cm, 10 * cm, 2 * cm, 2 * cm, 2 * cm])
        #Aplicamos estilos a las celdas de la tabla
        detalle_orden.setStyle(TableStyle(
        ...
        detalle_orden.wrapOn(pdf, 1000, 1000)
        #Definimos la coordenada donde se dibujará la tabla
        detalle_orden.drawOn(pdf, 580, 50)
    ...
    def tabla3(self,pdf,y):
        ...
        encabezados = ('Codigo Experto', 'Nombre Articulo', 'Stock', 'Bodega', 'Total Pedido')
        #Creamos una lista de tuplas que van a contener a las personas
        detalles = [(art.cod_experto, art.nombre, art.stock, art.info_bodega, art.total_pedido) for art in Articulo.objects.filter(cod_experto__range=["DRE-0161", "VV-0122"]).filter(info_bodega=1).order_by('cod_experto')]
        #Establecemos el tamaño de cada una de las columnas de la tabla
        detalle_orden = Table([encabezados] + detalles, colWidths=[3 * cm, 10 * cm, 2 * cm, 2 * cm, 2 * cm])
        #Aplicamos estilos a las celdas de la tabla
        detalle_orden.setStyle(TableStyle(
        ...
        detalle_orden.wrapOn(pdf, 1000, 1000)
        #Definimos la coordenada donde se dibujará la tabla
        detalle_orden.drawOn(pdf, 1150, 50)
